...
namespace CSharpCompiler
{
    public class ScriptBundleLoader
    {
        ...
        public ScriptBundle LoadScriptsBundle(IEnumerable<string> fileSources)
        {
            var bundle = new ScriptBundle(this, fileSources,false);
            allFilesBundle.Add(bundle);
            return bundle;
        }
        ...
        public class ScriptBundle
        {
            ...
            public ScriptBundle(ScriptBundleLoader manager, IEnumerable<string> filePaths,bool iswatch=true)
            {
