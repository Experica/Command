...
IsoLumc = [RGB(clamp.(hue_dkl_ilp[1:3,i],0,1)...) for i in 1:size(hue_dkl_ilp,2)]
...
# HSL equal angular distance hue[0:30:360] with matched physical luminance
using Colors
...
colordata = Dict("LMS_X"=>colorstring.([maxc_lms[:,1],minc_lms[:,1]]),
                ...
                "LMS_MichelsonContrast" => diag(mcc),
                ...
                "LMS_mMichelsonContrast" => diag(mmcc),
